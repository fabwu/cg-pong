 ...
 */
function drawSphere(gl, sphere, aVertexPositionId, aVertexColorId, aVertexNormalId, matrixIn, color) {
    "use strict";
    // bind the buffers
    gl.bindBuffer(gl.ARRAY_BUFFER, sphere.bufferVertices);
    ...
    mat4.translate(newMatrix, matrixIn, vec3.fromValues(0, 0, 0));

    gl.uniformMatrix4fv(uModelViewMatrixId, false, newMatrix);
